  ...
  return (
    <div className="flex flex-col items-center justify-center inset-0 fixed h-screen bg-gradient-to-r from-blue-500 to-purple-500">
      ...
      <Dropdown className="" isDisabled={!dropdownEnabled}>
        <DropdownTrigger>
          <Button className="capitalize absolute top-10 right-10">
            {selectedKeys}
          </Button>
        </DropdownTrigger>
        <DropdownMenu
        ...
        >
          <DropdownItem key="kanban">
            <Tooltip
              content="Creates a kanban board with user stories and requirments"
              placement="left"
            >
              Kanban
            </Tooltip>
          ...
          <DropdownItem key="general">
            <Tooltip
              content="Creates general meeting notes and summary with a relevent title"
              placement="left"
            >
              General
            </Tooltip>
